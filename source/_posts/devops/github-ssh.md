...
[Connect to GitHub using SSH](https://docs.github.com/en/github/authenticating-to-github/connecting-to-github-with-ssh) so you don't have to enter username/password everytime in the terminal.
