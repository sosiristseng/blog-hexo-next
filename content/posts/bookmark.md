...
- [Zotero](https://www.zotero.org/), an open-source reference manager. Also see [my post]({{< ref "pkgs/zotero.md" >}}) about Zotero.
...
- [VS Code](https://code.visualstudio.com/) [Julia](https://www.julia-vscode.org/) extensions.
...
- [PyPlot.jl examples by Gizmaa](https://github.com/gizmaa/Julia_Examples)
