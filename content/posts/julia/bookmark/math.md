...
- [Data Types](datatypes.md) Section
...
+ nrmm.jl(404) :: Posterior inference algorithms for normalized random measure mixtures.
+ UnumTests.jl(404) :: Some experiments with Unums.
...
+ Hashlib.jl(404) :: SHA1 implementation for Julia.
...
+ [DeepConvert.jl](https://github.com/jlapeyre/DeepConvert.jl) :: This package provides convenient literal construction of values of large data types. (No `Project.toml`)

### [Floating Point](https://en.wikipedia.org/wiki/Category:Floating_point)

For floating-point datatypes, see [Data Types](datatypes.md#numeric-data-types) Section.
...
+ QNaN.jl(404) :: Quiet NaNs were designed to propagate information from within numerical computations.
...
+ [LinearExpressions.jl](https://github.com/cdsousa/LinearExpressions.jl) :: Linear symbolic expressions for the Julia language. (No `Project.toml`)
...
+ green-fairy(404) :: Lattice trees.
+ InteriorPoint.jl(404) :: Primal-dual interior point solver for linear programs.
+ juliaSpot(404) :: The Julia implementation of the Spot Linear Algebra Package.
+ KrylovSolvers.jl(404) :: Solve sparse linear systems in an efficient and iterative manner with Krylov Solvers.
+ PolarFact.jl(404) :: A Julia package for the matrix polar decomposition.
+ SpecialMatrices.jl(404) :: Package that adds support for several common matrices: Strang, Hankel, Toeplitz, and Vander matrices.

### Matrices

[Wikipedia | Matrix Theory](https://en.wikipedia.org/wiki/Category:Matrix_theory)

> Special Array/Matrix Algorithms, for Array Types, see [Data Types](datatypes.md#array-types) section.
...
[Julia sparse](https://github.com/JuliaSparse) organization.
...
+ Meshpart.jl(404) :: A Julia port of some of the functions from John Gilbert and Shang Hua Teng's Meshpart toolbox.
+ Multifrontal.jl(404) :: Multifrontal direct solvers for sparse matrices.
...
[Julia DSP](https://github.com/JuliaDSP) organization.
...
+ PolyMath.jl(404) :: a package for polynomial arithmetic, calculus, interpolation and quadrature algorithms implemented in Julia.
...
[Wikipedia | Graph Theory](https://en.wikipedia.org/wiki/Category:Graph_theory)

For graph/tree datatypes, see [Data Types](datatypes.md#graph-data-types)
...
See the [graphics](graphics.md#geometry) section.

## Optimization

See the [optimization](optimization.md) section.
